...
class MBFacebookAlbumsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = cell as? MBFacebookAlbumCell, indexPath.row < albums.count {
    ...
    func showAlert(withError error: MBFacebookImagePickerError) {
        ...
        alertController.addAction(UIAlertAction(title: NSLocalizedString("MBIMAGEPICKER_OK", comment: ""),
                                                style: .default,
